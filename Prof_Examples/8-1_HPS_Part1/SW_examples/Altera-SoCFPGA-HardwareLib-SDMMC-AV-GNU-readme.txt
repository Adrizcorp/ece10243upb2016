...
1. In DS-5, build the application:
  ...
  1b. In the "Project Explorer" panel, right-mouse-click 
      "Altera-SoCFPGA-HardwareLib-SDMMC-AV-GNU" and select "Build Project".
...
5. In DS-5, configure the launch configuration.
  ...
  5b. In the options on the left, expand "DS-5 Debugger" and select
      "Altera-SoCFPGA-HardwareLib-SDMMC-AV-GNU".
...
2. In DS-5, launch the debug configuration.
  ...
  2b. In the "Debug Control" panel, right-mouse-click
      "Altera-SoCFPGA-HardwareLib-SDMMC-AV-GNU" and select
      "Connect to Target".
...
INFO: Using random seed = 0x27e29012.

INFO: Demo block I/O using address = 0x45c50800, size = 529408 bytes.
INFO: Writing to address 0x45c50800, size = 529408 bytes using block I/O.
INFO: Reading from address 0x45c50800, size = 529408 bytes using block I/O.
