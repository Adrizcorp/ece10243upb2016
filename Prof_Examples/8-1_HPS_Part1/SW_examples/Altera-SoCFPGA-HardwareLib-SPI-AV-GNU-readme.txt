...
SPI Slave by loopback in the FPGA on the Arria V SoC board.
...
The hardware design is contained in the folder named 'av_soc_devkit_spi_lpbk'.
...
1. In DS-5, build the application:
  ...
  1b. In the "Project Explorer" panel, right-mouse-click 
      "Altera-SoCFPGA-HardwareLib-SPI-AV-GNU" and select "Build Project".
...
5. In DS-5, configure the launch configuration.
  ...
  5b. In the options on the left, expand "DS-5 Debugger" and select
      "Altera-SoCFPGA-HardwareLib-SPI-AV-GNU".
...
1. In DS-5, launch the debug configuration.
  ...
  1b. In the "Debug Control" panel, right-mouse-click
      "Altera-SoCFPGA-HardwareLib-SPI-AV-GNU" and select
      "Connect to Target".
...
INFO: FPGA Image size is 6846376 bytes.
