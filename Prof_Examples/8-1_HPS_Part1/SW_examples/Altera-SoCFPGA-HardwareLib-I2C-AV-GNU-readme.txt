...
The hardware design is contained in the folder named 'av_soc_devkit_i2c_lpbk'.
...
1. In DS-5, build the application:
  ...
  1b. In the "Project Explorer" panel, right-mouse-click 
      "Altera-SoCFPGA-HardwareLib-I2C-AV-GNU" and select "Build Project".
...
5. In DS-5, configure the launch configuration.
  ...
  5b. In the options on the left, expand "DS-5 Debugger" and select
      "Altera-SoCFPGA-HardwareLib-I2C-AV-GNU".
...
av_soc_devkit_i2c_lpbk/output_files/ghrd_5astfd5k3.sof.
...
2. In DS-5, launch the debug configuration.
  ...
  2b. In the "Debug Control" panel, right-mouse-click
      "Altera-SoCFPGA-HardwareLib-I2C-AV-GNU" and select
      "Connect to Target".
...
INFO: Using random seed = 0x6be17f8.
...
INFO: Using random address = 0x05f9, size = 879 bytes.
INFO: Writing to EEPROM address 0x05f9, size = 879 bytes.
INFO: Writing single byte at address = 0x05f9.
INFO: Writing single byte at address = 0x05fa.
INFO: Writing single byte at address = 0x05fb.
INFO: Writing single byte at address = 0x05fc.
INFO: Writing single byte at address = 0x05fd.
INFO: Writing single byte at address = 0x05fe.
INFO: Writing single byte at address = 0x05ff.
...
INFO: Writing 32 byte page at address = 0x0700.
INFO: Writing 32 byte page at address = 0x0720.
INFO: Writing 32 byte page at address = 0x0740.
INFO: Writing 32 byte page at address = 0x0760.
INFO: Writing 32 byte page at address = 0x0780.
INFO: Writing 32 byte page at address = 0x07a0.
INFO: Writing 32 byte page at address = 0x07c0.
INFO: Writing 32 byte page at address = 0x07e0.
INFO: Writing 32 byte page at address = 0x0800.
INFO: Writing 32 byte page at address = 0x0820.
INFO: Writing 32 byte page at address = 0x0840.
INFO: Writing 32 byte page at address = 0x0860.
INFO: Writing 32 byte page at address = 0x0880.
INFO: Writing 32 byte page at address = 0x08a0.
INFO: Writing 32 byte page at address = 0x08c0.
INFO: Writing 32 byte page at address = 0x08e0.
INFO: Writing 32 byte page at address = 0x0900.
INFO: Writing 32 byte page at address = 0x0920.
INFO: Writing 32 byte page at address = 0x0940.
INFO: Writing single byte at address = 0x0960.
INFO: Writing single byte at address = 0x0961.
INFO: Writing single byte at address = 0x0962.
INFO: Writing single byte at address = 0x0963.
INFO: Writing single byte at address = 0x0964.
INFO: Writing single byte at address = 0x0965.
INFO: Writing single byte at address = 0x0966.
INFO: Writing single byte at address = 0x0967.
INFO: Reading from EEPROM address 0x05f9, size = 879 bytes.
INFO: Setting EEPROM pointer address to 0x05f9.
INFO: Sequentially reading 879 bytes from EEPROM.
