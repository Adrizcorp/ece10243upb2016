...
1. In DS-5, build the application:
  ...
  1b. In the "Project Explorer" panel, right-mouse-click 
      "Altera-SoCFPGA-HardwareLib-Timers-AV-GNU" and select "Build Project".
...
5. In DS-5, configure the launch configuration.
  ...
  5b. In the options on the left, expand "DS-5 Debugger" and select
      "Altera-SoCFPGA-HardwareLib-Timers-AV-GNU".
...
1. In DS-5, launch the debug configuration.
  ...
  1b. In the "Debug Control" panel, right-mouse-click
      "Altera-SoCFPGA-HardwareLib-Timers-AV-GNU" and select
      "Connect to Target".
...
INFO: OSC1 Timer0 Time to zero in milliseconds is 0.
INFO: OSC1 Timer0 Time to zero in microseconds is 1539.
...
INFO: For loop time elapsed = 30788.
INFO: Setting Global Timer Comparator.
INFO: Enabling Global Timer Interrupts.
INFO: Global Timer Interrupt Deltas.
INFO: Global Timer Comparator Interrupt Delta 1 = 31926.
INFO: Global Timer Comparator Interrupt Delta 2 = 32049.
INFO: Global Timer Comparator Interrupt Delta 3 = 31955.
INFO: Global Timer Comparator Interrupt Delta 4 = 32089.
INFO: Global Timer Comparator Interrupt Delta 5 = 31914.
INFO: Global Timer Comparator Interrupt Delta 6 = 31989.
INFO: Global Timer Comparator Interrupt Delta 7 = 32045.
INFO: Global Timer Comparator Interrupt Delta 8 = 31957.
INFO: Global Timer Comparator Interrupt Delta 9 = 32080.
...
INFO: Watchdog 0 Current time = 3 millisecs.
INFO: Watchdog 0 count = 41014.
INFO: Watchdog 0 count after reset= 131051.
