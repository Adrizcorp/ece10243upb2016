...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../lcd_soc.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x81140
SOPC_SYSID_FLAG += --sidp=0x81140
ELF_PATCH_FLAG  += --sidp 0x81140

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1466390984
SOPC_SYSID_FLAG += --timestamp=1466390984
ELF_PATCH_FLAG  += --timestamp 1466390984
