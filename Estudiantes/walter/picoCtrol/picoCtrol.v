...
wire [4:0]addr_picoCtro32_rom;
wire [15:0]instruccion;
wire clk_1hz, clk_1hz_syncro;
...
(
	...
	.sync(clk_1hz_syncro) 	// output  sync_sig
);
...
(
	...
	.reg_0(LED[7:0]) ,	// output [7:0] reg_0_sig
	.reg_1() ,	// output [7:0] reg_1_sig
	.reg_2() ,	// output [7:0] reg_2_sig
	.reg_3() ,	// output [7:0] reg_3_sig
	.instruction_ROM_Addr(addr_picoCtro32_rom[4:0]) ,	// output [4:0] instruction_ROM_Addr_sig
	.instruction_ROM_data(instruccion[15:0]) 	// input [15:0] instruction_ROM_data_sig
);

PicoCtrl_rom32_instructions PicoCtrl_rom32_instructions_inst
(
	.addr(addr_picoCtro32_rom[4:0]) ,	// input [4:0] addr_sig
	.data(instruccion[15:0]) 	// output [15:0] data_sig
);
