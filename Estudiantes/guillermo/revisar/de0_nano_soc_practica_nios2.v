...
//=======================================================
 ...
 nios_practica u0 (
     ...
     .noise_pulse_export (noise_pulse)  // noise_pulse.
 );
...
(
	...
	.noise(noise_nios[15:0]) ,	// input [15:0] noise_sig
	.noise_en(noise_en) ,	// input  noise_en_sig
	.sel_nota(sel_nota[9:0]) ,	// input [9:0] sel_nota_sig
	.noise_pulse(noise_pulse) ,	// input  noise_pulse_sig
	.div_freq_in(nota[31:0]) ,	// input [31:0] div_freq_in_sig
	.syn_guitar(guita_syn[15:0]) 	// output [15:0] syn_guitar_sig
);
...
(
	...
	.DACin({~guita_syn[15],guita_syn[14:0]}) ,	// input [16:0] DACin_sig
	.Clk(FPGA_CLK1_50) ,	// input  Clk_sig
