...
(
	...
	.instruction_ROM_Addr(addr_picoCtrl_rom32) ,	// output [4:0] instruction_ROM_Addr_sig
	.instruction_ROM_data(instruction) 	// input [15:0] instruction_ROM_data_sig
);

PicoCtrl_rom32_instructions PicoCtrl_rom32_instructions_inst
(
	.addr(addr_picoCtrl_rom32) ,	// input [4:0] addr_sig
	.data(instruction) 	// output [15:0] data_sig
);

div_freq div_freq_inst
(
	.clk(FPGA_CLK1_50) ,	// input  clk_sig
	.in(32'd12499999) ,	// input [31:0] in_sig
