...
alias com {
  echo "\[exec\] com"
  vlog "$QSYS_SIMDIR/submodules/nios_practica_sys_clk.v"   -work sys_clk  
  vlog "$QSYS_SIMDIR/submodules/nios_practica_sw.v"        -work sw       
  vlog "$QSYS_SIMDIR/submodules/nios_practica_sel_nota.v"  -work sel_nota 
  vlog "$QSYS_SIMDIR/submodules/nios_practica_pll.vo"      -work pll      
  vlog "$QSYS_SIMDIR/submodules/nios_practica_noise_en.v"  -work noise_en 
  vlog "$QSYS_SIMDIR/submodules/nios_practica_noise.v"     -work noise    
  vlog "$QSYS_SIMDIR/submodules/nios_practica_leds.v"      -work leds     
  vlog "$QSYS_SIMDIR/submodules/nios_practica_jtag_uart.v" -work jtag_uart
  vlog "$QSYS_SIMDIR/submodules/nios_practica_div_freq.v"  -work div_freq 
  vlog "$QSYS_SIMDIR/submodules/nios_practica_cpu.v"       -work cpu      
  vlog "$QSYS_SIMDIR/submodules/nios_practica_RAM_jesus.v" -work RAM_jesus
  vlog "$QSYS_SIMDIR/nios_practica.v"                                     
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L sys_clk -L sw -L sel_nota -L pll -L noise_en -L noise -L leds -L jtag_uart -L div_freq -L cpu -L RAM_jesus -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L sys_clk -L sw -L sel_nota -L pll -L noise_en -L noise -L leds -L jtag_uart -L div_freq -L cpu -L RAM_jesus -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
