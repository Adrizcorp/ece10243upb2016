...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_sys_clk.v"   -work sys_clk  
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_sw.v"        -work sw       
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_sel_nota.v"  -work sel_nota 
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_pll.vo"      -work pll      
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_noise_en.v"  -work noise_en 
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_noise.v"     -work noise    
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_leds.v"      -work leds     
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_jtag_uart.v" -work jtag_uart
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_div_freq.v"  -work div_freq 
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_cpu.v"       -work cpu      
  vlogan +v2k "$QSYS_SIMDIR/submodules/nios_practica_RAM_jesus.v" -work RAM_jesus
  vlogan +v2k "$QSYS_SIMDIR/nios_practica.v"                                     
fi
