...
module nios_practica_mm_interconnect_0 (
		...
		input  wire        noise_reset_reset_bridge_in_reset_reset,     //     noise_reset_reset_bridge_in_reset.reset
	...
	wire         cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> RAM_jesus_s1_agent:cp_valid
	wire  [97:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> RAM_jesus_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // RAM_jesus_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire  [11:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> RAM_jesus_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> RAM_jesus_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> RAM_jesus_s1_agent:cp_endofpacket
	...
	wire  [97:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> sw_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // sw_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire  [11:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [97:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> uart_s1_agent:cp_data
	...
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> div_freq_s1_agent:cp_valid
	wire  [97:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> div_freq_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // div_freq_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [11:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> div_freq_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> div_freq_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> div_freq_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> sys_clk_s1_agent:cp_valid
	wire  [97:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> sys_clk_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // sys_clk_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [11:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> sys_clk_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> sys_clk_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> sys_clk_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> noise_s1_agent:cp_valid
	wire  [97:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> noise_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // noise_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [11:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> noise_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> noise_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> noise_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> noise_en_s1_agent:cp_valid
	wire  [97:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> noise_en_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                     // noise_en_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [11:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> noise_en_s1_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> noise_en_s1_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> noise_en_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_010_src_valid;                                                     // cmd_mux_010:src_valid -> sel_nota_s1_agent:cp_valid
	wire  [97:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> sel_nota_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                     // sel_nota_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [11:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> sel_nota_s1_agent:cp_channel
	wire         cmd_mux_010_src_startofpacket;                                             // cmd_mux_010:src_startofpacket -> sel_nota_s1_agent:cp_startofpacket
	wire         cmd_mux_010_src_endofpacket;                                               // cmd_mux_010:src_endofpacket -> sel_nota_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> noise_pulse_s1_agent:cp_valid
	wire  [97:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> noise_pulse_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                     // noise_pulse_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [11:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> noise_pulse_s1_agent:cp_channel
	wire         cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> noise_pulse_s1_agent:cp_startofpacket
	wire         cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> noise_pulse_s1_agent:cp_endofpacket
	...
	wire         ram_jesus_s1_agent_rp_valid;                                               // RAM_jesus_s1_agent:rp_valid -> router_004:sink_valid
	wire  [97:0] ram_jesus_s1_agent_rp_data;                                                // RAM_jesus_s1_agent:rp_data -> router_004:sink_data
	wire         ram_jesus_s1_agent_rp_ready;                                               // router_004:sink_ready -> RAM_jesus_s1_agent:rp_ready
	wire         ram_jesus_s1_agent_rp_startofpacket;                                       // RAM_jesus_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         ram_jesus_s1_agent_rp_endofpacket;                                         // RAM_jesus_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [97:0] sw_s1_agent_rp_data;                                                       // sw_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [97:0] uart_s1_agent_rp_data;                                                     // uart_s1_agent:rp_data -> router_007:sink_data
	...
	wire         div_freq_s1_agent_rp_valid;                                                // div_freq_s1_agent:rp_valid -> router_008:sink_valid
	wire  [97:0] div_freq_s1_agent_rp_data;                                                 // div_freq_s1_agent:rp_data -> router_008:sink_data
	wire         div_freq_s1_agent_rp_ready;                                                // router_008:sink_ready -> div_freq_s1_agent:rp_ready
	wire         div_freq_s1_agent_rp_startofpacket;                                        // div_freq_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         div_freq_s1_agent_rp_endofpacket;                                          // div_freq_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [97:0] sys_clk_s1_agent_rp_data;                                                  // sys_clk_s1_agent:rp_data -> router_009:sink_data
	...
	wire         noise_s1_agent_rp_valid;                                                   // noise_s1_agent:rp_valid -> router_010:sink_valid
	wire  [97:0] noise_s1_agent_rp_data;                                                    // noise_s1_agent:rp_data -> router_010:sink_data
	wire         noise_s1_agent_rp_ready;                                                   // router_010:sink_ready -> noise_s1_agent:rp_ready
	wire         noise_s1_agent_rp_startofpacket;                                           // noise_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         noise_s1_agent_rp_endofpacket;                                             // noise_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         noise_en_s1_agent_rp_valid;                                                // noise_en_s1_agent:rp_valid -> router_011:sink_valid
	wire  [97:0] noise_en_s1_agent_rp_data;                                                 // noise_en_s1_agent:rp_data -> router_011:sink_data
	wire         noise_en_s1_agent_rp_ready;                                                // router_011:sink_ready -> noise_en_s1_agent:rp_ready
	wire         noise_en_s1_agent_rp_startofpacket;                                        // noise_en_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         noise_en_s1_agent_rp_endofpacket;                                          // noise_en_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire         sel_nota_s1_agent_rp_valid;                                                // sel_nota_s1_agent:rp_valid -> router_012:sink_valid
	wire  [97:0] sel_nota_s1_agent_rp_data;                                                 // sel_nota_s1_agent:rp_data -> router_012:sink_data
	wire         sel_nota_s1_agent_rp_ready;                                                // router_012:sink_ready -> sel_nota_s1_agent:rp_ready
	wire         sel_nota_s1_agent_rp_startofpacket;                                        // sel_nota_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire         sel_nota_s1_agent_rp_endofpacket;                                          // sel_nota_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire         noise_pulse_s1_agent_rp_valid;                                             // noise_pulse_s1_agent:rp_valid -> router_013:sink_valid
	wire  [97:0] noise_pulse_s1_agent_rp_data;                                              // noise_pulse_s1_agent:rp_data -> router_013:sink_data
	wire         noise_pulse_s1_agent_rp_ready;                                             // router_013:sink_ready -> noise_pulse_s1_agent:rp_ready
	wire         noise_pulse_s1_agent_rp_startofpacket;                                     // noise_pulse_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire         noise_pulse_s1_agent_rp_endofpacket;                                       // noise_pulse_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire  [97:0] cmd_demux_src3_data;                                                       // cmd_demux:src3_data -> crosser:in_data
	...
	wire  [97:0] crosser_out_data;                                                          // crosser:out_data -> cmd_mux_003:sink0_data
	...
	wire  [97:0] cmd_demux_src6_data;                                                       // cmd_demux:src6_data -> crosser_002:in_data
	...
	wire  [97:0] crosser_002_out_data;                                                      // crosser_002:out_data -> cmd_mux_006:sink0_data
	...
	wire  [11:0] cmd_demux_src8_channel;                                                    // cmd_demux:src8_channel -> crosser_004:in_channel
	...
	wire  [11:0] crosser_004_out_channel;                                                   // crosser_004:out_channel -> cmd_mux_008:sink0_channel
	...
	wire  [11:0] cmd_demux_src9_channel;                                                    // cmd_demux:src9_channel -> crosser_005:in_channel
	...
	wire  [11:0] crosser_005_out_channel;                                                   // crosser_005:out_channel -> cmd_mux_009:sink0_channel
	...
	wire  [11:0] cmd_demux_src10_channel;                                                   // cmd_demux:src10_channel -> crosser_006:in_channel
	...
	wire  [11:0] crosser_006_out_channel;                                                   // crosser_006:out_channel -> cmd_mux_010:sink0_channel
	...
	wire  [11:0] cmd_demux_src11_channel;                                                   // cmd_demux:src11_channel -> crosser_007:in_channel
	...
	wire  [11:0] crosser_007_out_channel;                                                   // crosser_007:out_channel -> cmd_mux_011:sink0_channel
	...
	wire  [97:0] rsp_demux_003_src0_data;                                                   // rsp_demux_003:src0_data -> crosser_008:in_data
	wire         rsp_demux_003_src0_ready;                                                  // crosser_008:in_ready -> rsp_demux_003:src0_ready
	wire  [11:0] rsp_demux_003_src0_channel;                                                // rsp_demux_003:src0_channel -> crosser_008:in_channel
	...
	wire  [97:0] crosser_008_out_data;                                                      // crosser_008:out_data -> rsp_mux:sink3_data
	wire         crosser_008_out_ready;                                                     // rsp_mux:sink3_ready -> crosser_008:out_ready
	wire  [11:0] crosser_008_out_channel;                                                   // crosser_008:out_channel -> rsp_mux:sink3_channel
	...
	wire  [97:0] rsp_demux_004_src0_data;                                                   // rsp_demux_004:src0_data -> crosser_009:in_data
	wire         rsp_demux_004_src0_ready;                                                  // crosser_009:in_ready -> rsp_demux_004:src0_ready
	wire  [11:0] rsp_demux_004_src0_channel;                                                // rsp_demux_004:src0_channel -> crosser_009:in_channel
	...
	wire  [97:0] crosser_009_out_data;                                                      // crosser_009:out_data -> rsp_mux:sink4_data
	wire         crosser_009_out_ready;                                                     // rsp_mux:sink4_ready -> crosser_009:out_ready
	wire  [11:0] crosser_009_out_channel;                                                   // crosser_009:out_channel -> rsp_mux:sink4_channel
	...
	wire  [11:0] rsp_demux_006_src0_channel;                                                // rsp_demux_006:src0_channel -> crosser_010:in_channel
	...
	wire  [11:0] crosser_010_out_channel;                                                   // crosser_010:out_channel -> rsp_mux:sink6_channel
	...
	wire  [11:0] rsp_demux_007_src0_channel;                                                // rsp_demux_007:src0_channel -> crosser_011:in_channel
	...
	wire  [11:0] crosser_011_out_channel;                                                   // crosser_011:out_channel -> rsp_mux:sink7_channel
	...
	wire  [11:0] rsp_demux_008_src0_channel;                                                // rsp_demux_008:src0_channel -> crosser_012:in_channel
	...
	wire  [11:0] crosser_012_out_channel;                                                   // crosser_012:out_channel -> rsp_mux:sink8_channel
	...
	wire  [11:0] rsp_demux_009_src0_channel;                                                // rsp_demux_009:src0_channel -> crosser_013:in_channel
	...
	wire  [11:0] crosser_013_out_channel;                                                   // crosser_013:out_channel -> rsp_mux:sink9_channel
	...
	wire  [11:0] rsp_demux_010_src0_channel;                                                // rsp_demux_010:src0_channel -> crosser_014:in_channel
	...
	wire  [11:0] crosser_014_out_channel;                                                   // crosser_014:out_channel -> rsp_mux:sink10_channel
	...
	wire  [11:0] rsp_demux_011_src0_channel;                                                // rsp_demux_011:src0_channel -> crosser_015:in_channel
	...
	wire  [11:0] crosser_015_out_channel;                                                   // crosser_015:out_channel -> rsp_mux:sink11_channel
	...
	wire         ram_jesus_s1_agent_rdata_fifo_src_valid;                                   // RAM_jesus_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] ram_jesus_s1_agent_rdata_fifo_src_data;                                    // RAM_jesus_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         ram_jesus_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_002:in_0_ready -> RAM_jesus_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> RAM_jesus_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> RAM_jesus_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                         // RAM_jesus_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> RAM_jesus_s1_agent:rdata_fifo_sink_error
	...
	wire         div_freq_s1_agent_rdata_fifo_out_valid;                                    // div_freq_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] div_freq_s1_agent_rdata_fifo_out_data;                                     // div_freq_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire         div_freq_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_006:in_0_ready -> div_freq_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> div_freq_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> div_freq_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // div_freq_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> div_freq_s1_agent:rdata_fifo_sink_error
	wire         sys_clk_s1_agent_rdata_fifo_out_valid;                                     // sys_clk_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] sys_clk_s1_agent_rdata_fifo_out_data;                                      // sys_clk_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire         sys_clk_s1_agent_rdata_fifo_out_ready;                                     // avalon_st_adapter_007:in_0_ready -> sys_clk_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_007_out_0_valid;                                         // avalon_st_adapter_007:out_0_valid -> sys_clk_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                          // avalon_st_adapter_007:out_0_data -> sys_clk_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                         // sys_clk_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                         // avalon_st_adapter_007:out_0_error -> sys_clk_s1_agent:rdata_fifo_sink_error
	wire         noise_s1_agent_rdata_fifo_out_valid;                                       // noise_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] noise_s1_agent_rdata_fifo_out_data;                                        // noise_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire         noise_s1_agent_rdata_fifo_out_ready;                                       // avalon_st_adapter_008:in_0_ready -> noise_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_008_out_0_valid;                                         // avalon_st_adapter_008:out_0_valid -> noise_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                          // avalon_st_adapter_008:out_0_data -> noise_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                         // noise_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                         // avalon_st_adapter_008:out_0_error -> noise_s1_agent:rdata_fifo_sink_error
	wire         noise_en_s1_agent_rdata_fifo_out_valid;                                    // noise_en_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] noise_en_s1_agent_rdata_fifo_out_data;                                     // noise_en_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_009:in_0_data
	wire         noise_en_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_009:in_0_ready -> noise_en_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_009_out_0_valid;                                         // avalon_st_adapter_009:out_0_valid -> noise_en_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                          // avalon_st_adapter_009:out_0_data -> noise_en_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                         // noise_en_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                         // avalon_st_adapter_009:out_0_error -> noise_en_s1_agent:rdata_fifo_sink_error
	wire         sel_nota_s1_agent_rdata_fifo_out_valid;                                    // sel_nota_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_010:in_0_valid
	wire  [33:0] sel_nota_s1_agent_rdata_fifo_out_data;                                     // sel_nota_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_010:in_0_data
	wire         sel_nota_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_010:in_0_ready -> sel_nota_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_010_out_0_valid;                                         // avalon_st_adapter_010:out_0_valid -> sel_nota_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_010_out_0_data;                                          // avalon_st_adapter_010:out_0_data -> sel_nota_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_010_out_0_ready;                                         // sel_nota_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire   [0:0] avalon_st_adapter_010_out_0_error;                                         // avalon_st_adapter_010:out_0_error -> sel_nota_s1_agent:rdata_fifo_sink_error
	wire         noise_pulse_s1_agent_rdata_fifo_out_valid;                                 // noise_pulse_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_011:in_0_valid
	wire  [33:0] noise_pulse_s1_agent_rdata_fifo_out_data;                                  // noise_pulse_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_011:in_0_data
	wire         noise_pulse_s1_agent_rdata_fifo_out_ready;                                 // avalon_st_adapter_011:in_0_ready -> noise_pulse_s1_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> noise_pulse_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> noise_pulse_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_011_out_0_ready;                                         // noise_pulse_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire   [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> noise_pulse_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_50mhz_clk_clk),                       //                      clk.clk
		.reset                  (noise_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_50mhz_clk_clk),                         //             clk.clk
		.reset                   (noise_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	nios_practica_mm_interconnect_0_router_003 router_003 (
	...
	nios_practica_mm_interconnect_0_router_003 router_004 (
	...
	nios_practica_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (pll_outclk0_clk),                       //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (pll_outclk0_clk),                       //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (pll_outclk0_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_50mhz_clk_clk),                    //       clk.clk
		.reset              (sw_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_50mhz_clk_clk),                    //       clk.clk
		.reset              (sw_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (pll_outclk0_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_rsp_demux_003 rsp_demux_006 (
		.clk                (clk_50mhz_clk_clk),                    //       clk.clk
		.reset              (sw_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_rsp_demux_003 rsp_demux_007 (
		.clk                (clk_50mhz_clk_clk),                    //       clk.clk
		.reset              (sw_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_rsp_demux_003 rsp_demux_008 (
		.clk                (clk_50mhz_clk_clk),                       //       clk.clk
		.reset              (noise_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_rsp_demux_003 rsp_demux_009 (
		.clk                (clk_50mhz_clk_clk),                       //       clk.clk
		.reset              (noise_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_rsp_demux_003 rsp_demux_010 (
		.clk                (clk_50mhz_clk_clk),                       //       clk.clk
		.reset              (noise_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_practica_mm_interconnect_0_rsp_demux_003 rsp_demux_011 (
		.clk                (clk_50mhz_clk_clk),                       //       clk.clk
		.reset              (noise_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (cpu_reset_reset_bridge_in_reset_reset),   //  in_clk_reset.reset
		.out_clk           (clk_50mhz_clk_clk),                       //       out_clk.clk
		.out_reset         (noise_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (clk_50mhz_clk_clk),                       //        in_clk.clk
		.in_reset          (noise_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
		.out_clk           (pll_outclk0_clk),                         //       out_clk.clk
		.out_reset         (cpu_reset_reset_bridge_in_reset_reset),   // out_clk_reset.reset
	...
	nios_practica_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_50mhz_clk_clk),                       // in_clk_0.clk
		.in_rst_0_reset (noise_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
